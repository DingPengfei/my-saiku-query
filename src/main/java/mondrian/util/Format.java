...
public class Format {
     ...
     * "en", or "" for the default) to a {@link FormatLocale}.
     */
    ...
    /**
     * LiteralFormat is an implementation of {@link BasicFormat} which
    ...
    /**
     * CompoundFormat is an implementation of {@link BasicFormat} where
    ...
    /**
     * JavaFormat is an implementation of {@link BasicFormat} which
    ...
    /**
     * NumericFormat is an implementation of {@link BasicFormat} which
    ...
    /**
     * DateFormat is an element of a {@link CompoundFormat} which has a
     ...
     * {@link BasicFormat#format(Date, StringBuilder)} calls
     ...
     * LiteralFormat} objects for "/".  A {@link CompoundFormat} object
