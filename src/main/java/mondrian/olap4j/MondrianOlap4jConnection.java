...
/**
 * Implementation of {@link OlapConnection}
 * for the Mondrian OLAP engine.
 *
 * <p>This class has sub-classes which implement JDBC 3.0 and JDBC 4.0 APIs;
 * it is instantiated using
 * {@link Factory#newConnection(MondrianOlap4jDriver, String, Properties)}.</p>
 *
 * <p>This class is public, to allow access to the
 * {@link #setRoleNames(List)} method before it is added to olap4j
...
public abstract class MondrianOlap4jConnection implements OlapConnection {
     ...
     * See {@link MondrianOlap4jDriver} for more details.
     *
