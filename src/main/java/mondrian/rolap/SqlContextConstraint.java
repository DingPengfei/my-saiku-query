    ...
    implements MemberChildrenConstraint, TupleConstraint
{
    ...
    * methods {@link MemberChildrenConstraint#addMemberConstraint(SqlQuery, RolapCube, AggStar, RolapMember)} and
    * {@link MemberChildrenConstraint#addMemberConstraint(SqlQuery, RolapCube, AggStar, List)} will
