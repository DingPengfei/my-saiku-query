 ...
 *     objects (say the {@link ResultSet}) gives an error;
...
public class SqlStatement {
    ...
    public SqlStatement(
        ...
        Functor1<Void, Statement> callback)
    {
     ...
     * of this column: the default is {@link ResultSet#getObject(int)},
     ...
     * calls to the result set inside a {@link SqlStatement}.
        ...
        extends DelegatingInvocationHandler
    {
        ...
        /**
         * Helper method to implement {@link ResultSet#close()}.
         *
