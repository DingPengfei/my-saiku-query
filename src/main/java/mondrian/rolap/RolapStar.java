...
public class RolapStar {
    ...
    /**
     * Retrieves the {@link Measure} in which a measure is stored.
     */
     ...
     * {@link MondrianDef.RelationOrJoin} so may, in fact, be a
     * view.
     *
    ...
    public static class Table {
        ...
        synchronized void makeMeasure(RolapBaseCubeMeasure measure) {
            ...
            Measure starMeasure = new Measure(
                measure.getName(),
            ...
            String usagePrefix)
        {
            ...
            if (xmlExpr instanceof MondrianDef.Column) {
                ...
                AliasReplacer aliasReplacer =
                    new AliasReplacer(tableName, table.getAlias());
            ...
            Condition joinCondition)
        {
            if (relationOrJoin instanceof MondrianDef.Relation) {
                ...
                Table rightTable = leftTable.addJoin(
         ...
         */
        public Table findTableWithLeftJoinCondition(
         ...
         */
        public Table findTableWithLeftCondition(
