    ...
    implements RolapMember
{
     ...
     * {@link CacheControl#createMoveCommand}.
     *
     ...
     * which implementation of {@link Map} to use to store
    ...
    public interface PropertyValueMapFactory {
        /**
         * Creates a {@link Map} to be used for storing
    ...
    /**
     * Default {@link PropertyValueMapFactory}
     * implementation, used if
     * {@link MondrianProperties#PropertyValueMapFactoryClass}
     * is not set.
     */
        ...
        implements PropertyValueMapFactory
    {
         ...
         * is a measure, the factory will create a {@link HashMap}.
         * </p>
         *
     ...
     * {@link DefaultPropertyValueMapFactory}. </p>
     */
