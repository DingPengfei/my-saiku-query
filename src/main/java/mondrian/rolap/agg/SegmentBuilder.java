...
public class SegmentBuilder {
        ...
        Datatype datatype)
    {
        ...
        List<Entry<SegmentHeader, SegmentBody>>  segments =
        ...
        for (Entry<SegmentHeader, SegmentBody> entry : segments) {
        ...
        for (Entry<SegmentHeader, SegmentBody> entry : map.entrySet()) {
            ...
            entryLoop:
            for (Entry<CellKey, Object> vEntry : v.entrySet()) {
                z = 0;
        ...
        if (LOGGER.isDebugEnabled()) {
            ...
            for (Entry<SegmentHeader, SegmentBody > segment : segments) {
    ...
    private static class ExcludedRegionList
        extends AbstractList<ExcludedRegion>
        implements ExcludedRegion
    {
     ...
     * {@link AggregationKey}
     * and {@link CellRequest} as context to
     * convert a {@link SegmentHeader}.
     *
