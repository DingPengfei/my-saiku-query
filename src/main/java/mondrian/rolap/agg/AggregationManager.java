...
public class AggregationManager extends RolapAggregationManager {
     ...
     *   Use {@link MondrianServer#getAggregationManager()}.
     *   To get a server, call
     *   {@link MondrianServer#forConnection(mondrian.olap.Connection)},
     ...
     *     types of columns
     */
    public static Pair<String, List<Type>> generateSql(
