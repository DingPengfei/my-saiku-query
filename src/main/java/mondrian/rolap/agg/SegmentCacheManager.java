 ...
 *
 * <p>3. Delete {@link RolapStar#lookupOrCreateAggregation}
 * and {@link RolapStar#lookupSegment}
 * and {@link RolapStar}.lookupAggregationShared
 ...
 *
 * <p>1. {@link RolapStar#getCellFromCache} moved from
 ...
 *
 * <p>8. Longer term. Move {@link RolapStar.Bar}.segmentRefs to
 * {@link Execution}. Would it still be thread-local?</p>
 *
 * <p>10. Call
 * {@link DataSourceChangeListener#isAggregationChanged}.
 ...
 * {@link SegmentBuilder.SegmentConverter} is a hack that
 ...
 * {@link SegmentCacheManager#peek}.</p>
 *
 ...
 * copying.</p>
 *
 * <p>21. Obsolete {@link CombiningGenerator}.</p>
 *
 * <p>22. {@link SegmentHeader#constrain(SegmentColumn[])} is
...
public class SegmentCacheManager {
    ...
    /**
     * Copy-pasted from {@link Monitor}. Consider
    ...
    private class PeekCommand
        implements Command<PeekResponse>
    {
