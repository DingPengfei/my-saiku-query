...
public class JdbcSchema {
    ...
    /**
     * Converts a {@link Types} value to a
     * {@link Dialect.Datatype}.
     *
     * @param javaType JDBC type code, as per {@link Types}
     * @return Datatype
     */
    ...
    public class Table {
         ...
         */
        public Iterator<Column.Usage> getColumnUsages(
                ...
                implements Iterator<Column.Usage>
            {
                ...
                public boolean hasNext() {
                    while (true) {
                        ...
                        Column.Usage usage = usageIter.next();
