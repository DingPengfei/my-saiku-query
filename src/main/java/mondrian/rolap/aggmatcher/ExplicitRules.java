...
public class ExplicitRules {
     ...
     */
    public static TableDef getIncludeByTableDef(
        final String tableName,
        final List<Group> aggGroups)
    {
        for (Group group : aggGroups) {
    ...
    public static class Group {
         ...
         * Add an exclude rule.
         */
        public void addExclude(final Exclude exclude) {
         ...
         */
        public TableDef getIncludeByTableDef(
            final String tableName)
        {
...
//                }
            ...
            return new Recognizer.Matcher() {
                public boolean matches(final String name) {
                    for (Iterator<String> it =
                            TableDef.this.getIgnoreColumnNames();
                        it.hasNext();)
                    {
    ...
    static class NameTableDef extends TableDef {
        /**
         * Makes a NameTableDef from the catalog schema.
         */
        static NameTableDef make(
    ...
    public static class PatternTableDef extends TableDef {
         ...
         */
        static PatternTableDef make(
            final MondrianDef.AggPattern aggPattern,
            final Group group)
        {
            PatternTableDef pattern =
                new PatternTableDef(
            ...
            TableDef.add(pattern, aggPattern);
