...
//printNotSeenForeignKeys(notSeenForeignKeys);
    ...
    /**
     * Given a {@link MondrianDef.Expression}, returns
     * the associated column name.
     *
     * <p>Note: if the {@link MondrianDef.Expression} is
     * not a {@link MondrianDef.Column} or {@link
     * MondrianDef.KeyExpression}, returns null. This
