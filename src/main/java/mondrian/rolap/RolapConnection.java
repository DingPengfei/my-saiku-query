 ...
 * {@link DriverManager#getConnection(String, CatalogLocator)}.
...
public class RolapConnection extends ConnectionBase {
    ...
    /**
     * Returns the instance of the {@link DataSourceResolver}
     * plugin.
     *
     ...
     *     the property file
     *
     * @deprecated Use {@link #execute(Execution)}; this method
