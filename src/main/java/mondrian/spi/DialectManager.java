...
/**
 * Manages {@link Dialect} and {@link DialectFactory}
 * objects.
 *
 * @author jhyde
 * @since Jan 13, 2009
...
public abstract class DialectManager {
    ...
    /**
     * Implementation class for {@link DialectManager}.
     *
    ...
    private static class DialectManagerImpl {
         ...
         * {@link ServiceDiscovery} for more details.)
         */
        DialectManagerImpl() {
        ...
        /**
         * Implements {@link DialectManager#createDialect(DataSource,Connection)}.
         *
    ...
    /**
     * Implementation of {@link DialectFactory} that caches
     * dialects based on data source.
     *
     * @see Dialect#allowsDialectSharing()
     */
