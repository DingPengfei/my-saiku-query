...
/**
 * Implementation of {@link DialectFactory} for subclasses
 * of {@link JdbcDialectImpl}.
 *
 * <p>Assumes that the dialect has a public constructor that takes a
 * {@link Connection} as a parameter.
 */
public class JdbcDialectFactory implements DialectFactory {
     ...
     * {@link DialectFactory#createDialect(DataSource, Connection)}.
     *
     * <p>Helper method, called when {@code createDialect} is called without a
     * {@link Connection} and the dialect factory
     * cannot create a dialect with {@link DataSource} alone.
     *
