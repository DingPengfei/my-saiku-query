 ...
 * {@link DialectFactory} for more details.</p>
 *
 * <h3>Registering dialects</h3>
 *
 * <p>A dialect needs to be registered with the system in order to be used.
 * Call {@link DialectManager#register(DialectFactory)}
 * to register a dialect factory, or
 * {@link DialectManager#register(Class)} to register a dialect
 * class.
 *
...
public interface Dialect {
     ...
     * {@link DatabaseProduct#UNKNOWN} if the database is
