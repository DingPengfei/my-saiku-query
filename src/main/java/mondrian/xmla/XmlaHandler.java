...
//                throw new SAXException("Too many axes: " + axisCount);
    ...
    private static class XmlaExtraImpl implements XmlaExtra {
        ...
        public boolean isPropertyInternal(Property property) {
            return
                property instanceof StandardMemberProperty
                && ((StandardMemberProperty) property).isInternal()
                || property instanceof StandardCellProperty
                && ((StandardCellProperty) property).isInternal();
        }
        ...
        public Object getMemberKey(Member m) throws OlapException {
            return
                m.getPropertyValue(
                    StandardMemberProperty.MEMBER_KEY);
        }
