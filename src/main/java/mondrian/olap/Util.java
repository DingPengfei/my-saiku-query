...
public class Util extends XOMUtil {
     ...
     * things are available via {@link UtilCompatible}.
     * Retroweaver has some problems involving {@link EnumSet}.
     */
     ...
     *
     * <p>The inverse operation of {@link Locale#toString()}.
     *
    ...
    /**
     * Sorts a collection of objects using a {@link Comparator} and returns a
     * list.
     *
     * @param collection Collection
    ...
    /**
     * Calls {@link Future#get()} and converts any
     ...
     * class name if the exception is derived from {@link SQLException}
     * or is exactly a {@link Exception}.
     */
    public static String getErrorMessage(Throwable err) {
        boolean prependClassName =
            !(err instanceof SQLException
              || err.getClass() == Exception.class);
     ...
     *   is derived from {@link SQLException} or is exactly a {@link
     *   Exception}
     */
    ...
    /**
     * Like <code>{@link Arrays}.copyOf(double[], int)</code>, but
    ...
    /**
     * Like <code>{@link Arrays}.copyOf(int[], int)</code>, but
     * exists prior to JDK 1.6.
     *
     * @param original the array to be copied
     * @param newLength the length of the copy to be returned
    ...
    /**
     * Like <code>{@link Arrays}.copyOf(long[], int)</code>, but
     * exists prior to JDK 1.6.
     *
     * @param original the array to be copied
     * @param newLength the length of the copy to be returned
    ...
    /**
     * Like <code>{@link Arrays}.copyOf(Object[], int)</code>, but
     * exists prior to JDK 1.6.
     *
     * @param original the array to be copied
     * @param newLength the length of the copy to be returned
    ...
    /**
     * Creates a hash set that, like {@link IdentityHashMap},
