 ...
 * {@link Connection#getCacheControl}.</p>
 *
 ...
 * <li>{@link #createUnionRegion(CellRegion[])}</li>
 * <li>{@link #createCrossjoinRegion(CellRegion[])}</li>
 * <li>{@link #createMeasuresRegion(Cube)}</li>
 * <li>{@link #flush(CellRegion)}</li>
 * </ul></p>
 *
 ...
 * <li>{@link #createDeleteCommand(MemberSet)}</li>
 * <li>{@link #createCompoundCommand(List)}</li>
 * <li>{@link #createCompoundCommand(MemberEditCommand[])}</li>
 * <li>{@link #createSetPropertyCommand(Member, String, Object)}</li>
 * <li>{@link #createSetPropertyCommand(MemberSet,Map)}</li>
 * <li>{@link #flush(MemberSet)}</li>
 * <li>{@link #execute(MemberEditCommand)}</li>
 * </ul></p>
 *
 * @author jhyde
 * @since Sep 27, 2006
...
public interface CacheControl {
    ...
    public interface CellRegion {
         ...
         * @return a list of {@link Dimension} objects.
         */
     ...
     * {@link CacheControl#createUnionSet(MemberSet[])}.
     */
