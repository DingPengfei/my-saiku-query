...
public class Query extends QueryPart {
     ...
     *
     * <p>Note especially that {@link #getCalculatedMember(List)}
    ...
    /**
     * Implementation of {@link Validator} that works within a
     * particular query.
     *
     ...
     * the majority of the code in {@link ValidatorImpl}, the
