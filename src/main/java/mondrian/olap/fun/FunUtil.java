...
public class FunUtil extends Util {
     ...
     * has returned the MDX null value. See {@link IntegerCalc}.
     */
     ...
     * {@link #evaluateTuples(Evaluator, Calc, TupleList)}.
     *
     ...
     *
     * @see #hierarchizeTupleList(TupleList, boolean)
     */
     ...
     * @param post Whether to sort in post order; if false, sorts in pre order
     *
     * @see #hierarchizeMemberList(List, boolean)
     */
    ...
    */
     ...
     *
     *
     * @param evaluator Evaluator, provides a {@link SchemaReader}
     *   and {@link Cube}
